...
<form action="{{ route('warnas.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    {{-- <div class="mb-3">
    ...
    <div class="mb-5">
        <h3 class="text-lg leading-6 font-medium text-gray-900">Add New Color</h3>
    </div>
    <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
        <label for="username" class="block text-sm font-medium text-gray-700 sm:mt-px sm:pt-2"> New Color Name
        </label>
    ...
    <div class="pt-5">
        <a href="/admin/listwarna"><div class="">
            <button type="button"
