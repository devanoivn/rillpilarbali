                ...
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-1 lg:grid-cols-1">
                            ...
                            <div class="p-5">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-5 w-0 flex-1">
                                        <dl>
                                            <dt class="text-sm font-medium text-gray-500 truncate">Kayu</dt>
                                            <dd>
                        ...
                        <div class="mt-6 flex space-x-3 md:mt-0 md:ml-4 flex justify-end">
                            ...
                            <a href="/admin/addkayu"><button type="button"
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="bg-white">
                                            ...
                                            <td class="px-6 py-4 text-right whitespace-nowrap text-sm text-lime-600 ">
                                                <a href="{{route("kayus.edit",$kay->id)}}"><button>Edit</button></a>
                                            </td>
                                            <td class="px-6 py-4 text-right whitespace-nowrap text-sm text-orange-500">
                                                <form action="{{route("kayus.destroy", $kay->id)}}" method=POST>
                                                    @csrf
                                                    @method('DELETE')
