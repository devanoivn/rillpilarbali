            ...
            <div class="mt-0">
                <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {{-- <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-1 lg:grid-cols-2">
                        <!-- Card -->
                        <div class="bg-white overflow-hidden shadow rounded-lg w-1/2">
                            <div class="p-5">
                        ...
                        <div class="mt-6 flex space-x-3 md:mt-0 md:ml-4 flex justify-end">

                            <a href="/admin/addproduct"><button type="button"
                                    class="items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500">Add
                                    Product</button></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr class="bg-white">
                                            ...
                                            <td class="px-6 py-4 text-right whitespace-nowrap text-sm text-gray-500">
                                                <span class="text-gray-900 font-medium">$ {{$pro['price']}}</span>
                                            ...
                                            <td class="px-6 py-4 text-right whitespace-nowrap text-sm text-lime-600 ">
                                                <a href="{{route("products.edit",$pro->id)}}"><button>Edit</button></a>
                                            </td>
                                            <td class="px-6 py-4 text-right whitespace-nowrap text-sm text-orange-500">
