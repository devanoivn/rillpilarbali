    ...
    -->
            <div class="absolute top-0 right-0 -mr-12 pt-2">
                <button type="button"
                    ...
                    <svg class="h-6 w-6 text-white" xmlns="/images/pbb.svg" fill="none" viewBox="0 0 24 24"
            ...
            <div class="flex-shrink-0 flex items-center px-4">
                <img class="h-8 w-auto" src="/images/pb.png" alt="pilarbali logo">
            </div>
    ...
    <div class="lg:pl-64 flex flex-col flex-1">
        <div class="relative z-10 flex-shrink-0 flex h-16 bg-white border-b border-gray-200 lg:border-none">
            <button type="button"
                ...
                <svg class="h-6 w-6" xmlns="    " fill="none" viewBox="0 0 24 24" stroke="currentColor"
                    aria-hidden="true">
                    ...
                    <div class="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                        <div class="flex-1 min-w-0">
                            ...
                            <div class="flex items-center">
                                <img class="hidden h-16 w-16 rounded-full sm:block" src="/images/admin.png" alt="">
                                <div>
                                    <div class="flex items-center">
                        ...
                        <div class="mt-6 flex space-x-3 md:mt-0 md:ml-4">
                            ...
                            <a href="/admin/addproduct"><button type="button"
                                    class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-cyan-600 hover:bg-cyan-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cyan-500">Add
                                    Product</button></a>
                        </div>
                    </div>
                </div>
                        ...
                        {{-- <div class="mt-2 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <div class="bg-white overflow-hidden shadow rounded-lg">
                                <div class="p-5">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-5 w-0 flex-1">
                                            <dl>
                                                <dt class="text-sm font-medium text-gray-500 truncate">Total Product</dt>
                                                <dd>
                                ...
                                <div class="bg-gray-50 px-5 py-3">
                                    <div class="text-sm">
                                        <a href="/admin/listproduct" class="font-medium text-cyan-700 hover:text-cyan-900">
                                            View
                                            all </a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white overflow-hidden shadow rounded-lg">
                                ...
                                <div class="bg-gray-50 px-5 py-3">
                                    <div class="text-sm">
                                        <a href="/admin/listuser" class="font-medium text-cyan-700 hover:text-cyan-900">
                                            View
                                            all </a>
                                    </div>
                                </div>
                            ...
                            <div class="bg-white overflow-hidden shadow rounded-lg">
                                ...
                                <div class="bg-gray-50 px-5 py-3">
                                    <div class="text-sm">
                                        <a href="/admin/listorder" class="font-medium text-cyan-700 hover:text-cyan-900">
                                            View
                                            all </a>
                                    </div>
                                </div>
